...
function LanguageStepThree() {
    ...
    async function handleSubmit(e) {
      ...
      try {
          ...
          await axios.post("http://localhost:8000/languageform/", formData);
          Swal.fire({
              icon: 'success',
              title: 'Success!',
  ...
  return (
    <div className='language-main-container'>
        ...
        <label htmlFor="">Tell us your goal
        </label>
             <textarea name="goal" id="goal" placeholder='What is your specific goal for this lesson? Be as detailed as possible to help us get the most suitable tutor.'></textarea>
          </div>
        <div className="language-input-container">
