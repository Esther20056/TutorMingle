...
function Signup() {
    ...
    const validateForm = (formData) => {
        ...
        if (!start_year) {
            newErrors.grade = 'Start year is required';
            valid = false;
        }
        const end_year = formData.get('end_year');
        if (!end_year) {
            newErrors.grade = 'End year is required';
            valid = false;
        }
                ...
                <form action="" className="signup_container" onSubmit={handleSubmit}>
                    ...
                    <div className="signup-outer-wrapper">
                        ...
                        <div className="signup-inner-wrapper">
                            ...
                            <div className="form-input-container">
                                ...
                                <input type="text" placeholder='e.g. Nigeria' name="nationality" required />
                            ...
                            <div className="form-input-container">
                                ...
                                <input type="file" name="identification" style={{outline: 'none', paddingTop: '0.8rem' }}/>
                                {errors.identification && <span className="error">{errors.identification}</span>}
                            </div>
                            <div className="form-input-container">
                                <label htmlFor="profile">Profile Picture</label>
                                <input type="file" name="profile" style={{outline: 'none', paddingTop: '0.8rem' }}/>
                    ...
                    <div className="signup-outer-wrapper">
                        ...
                        <div className="signup-inner-wrapper">
                            ...
                            <div className="form-input-container">
                                ...
                                <input type="text" placeholder='e.g Ikeja' name="region" required />
                    ...
                    <div className="signup-outer-wrapper">
                        ...
                        <div className="signup-inner-wrapper">
                            ...
                            <div className="form-input-container">
                                <label htmlFor="school_name">Educational Institution Name</label>
                    ...
                    <button type="submit" className="button" disabled={loading}>                       {loading ? 'Submitting...' : 'Save and Continue'}
                    </button>
                </form>
            </div>
        </div>
